...
const ProjectCard = ({name, url, description, githubLink}: ProjectCardProps) => {
      ...
      {onFront ? 
               ...
               :
                <div className="back__cover">
                  ...
                  <h4 className='card__title'>Github Repo: <a className='card__content' href={githubLink} target='_blank'>{githubLink}</a></h4>
                </div>
      }
    </div>
  )
